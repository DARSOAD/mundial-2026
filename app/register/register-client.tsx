...
export default function RegisterClient() {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      // 1. Fetch data to calculate leaderboard
      ...
      // 2. Calculate leaderboard (simplified points calculation)
